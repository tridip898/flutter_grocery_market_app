...
class _VegetablePageState extends State<VegetablePage> {
  ...
  _readData() async {
    await DefaultAssetBundle.of(context)
        .loadString("lib/json/vegetable.json")
        .then((value) => setState(() {
              veg = json.decode(value);
            }));
  }
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    color: Colors.red,
                    image: DecorationImage(
                        image: AssetImage("lib/images/vege_back.jpg"),
                        fit: BoxFit.cover),
                      ...
                      return GestureDetector(
                        onTap: () {
                          Get.to(() => ProductDetail(), arguments: {
                            'name': veg[index]['item'].toString(),
                            'image': veg[index]['image'].toString(),
                            'price': veg[index]['new_price'].toString(),
                            'quantity': veg[index]['quantity'].toString(),
                            'determiner':veg[index]['determiner'].toString(),
                            'description': veg[index]['description'].toString()
                          });
                        },
                        child: Container(
                          decoration: BoxDecoration(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage(veg[index]['image']),
                                        fit: BoxFit.cover),
                                    borderRadius: BorderRadius.only(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      veg[index]['quantity']+veg[index]['determiner'],
                                      style: TextStyle(
                                          fontSize: 16,
