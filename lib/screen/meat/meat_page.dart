...
class _MeatPageState extends State<MeatPage> {
  ...
  _readData() async {
    await DefaultAssetBundle.of(context)
        .loadString("lib/json/meat.json")
        .then((value) => setState(() {
              meat = json.decode(value);
            }));
  }
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: Colors.red,
                      image: DecorationImage(
                          image: AssetImage("lib/images/beef_back.jpg"),
                          fit: BoxFit.cover),
                        ...
                        return GestureDetector(
                          onTap: () {
                            Get.to(() => ProductDetail(), arguments: {
                              'name': meat[index]['item'].toString(),
                              'image': meat[index]['image'].toString(),
                              'price': meat[index]['new_price'].toString(),
                              'quantity': meat[index]['quantity'].toString(),
                              'determiner':meat[index]['determiner'].toString(),
                              'description':
                                  meat[index]['description'].toString()
                            });
                          },
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        meat[index]['quantity']+meat[index]['determiner'],
                                        style: TextStyle(
                                            fontSize: 16,
